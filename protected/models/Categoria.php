...
class Categoria extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('departamento_iddepartamento, nombre, orden, visible', 'required'),
			array('visible', 'numerical', 'integerOnly'=>true),
			array('departamento_iddepartamento, orden', 'length', 'max'=>10),
			array('nombre', 'length', 'max'=>75),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idcategoria, departamento_iddepartamento, nombre, orden, visible', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    ...
                    'subcategoria' => array(self::HAS_MANY,'Subcategoria','categoria_idcategoria'),
		);
	}
	...
	public static function model($className=__CLASS__)
	{
        ...
        public static function getListCategorias(){
            return CHtml::listData(Categoria::model()->findAll(),'idcategoria','Categoria_Departamento');
        }
        
        public function getCategoria_Departamento()
        {
