 ...
 * @property string $idtipo_usuario
...
class TipoUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idtipo_usuario, nombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idtipo_usuario',$this->idtipo_usuario,true);
	...
	public static function model($className=__CLASS__)
	{
        ...
        public static function getListTiposUsuario(){
